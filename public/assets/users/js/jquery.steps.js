...
function paginationClickHandler(event)
{
    ...
    switch (href.substring(href.lastIndexOf("#") + 1))
    {
        ...
        case "finish":
            // var count = $("#check_confirm[type='checkbox']:checked").length;
            // if(count === 0){
            //     Swal.fire('Cancelled','Please check terms and conditions','error')
            //     return false;
            // }else{
        ...
        case "next":
            ...
            if(state.currentIndex == 0){
                ...
                //  form_data.append("pf_logo",file_data ); // comment this
                 ...
                 ajax_function(form_data, "first", state.currentIndex);
            }
            ...
            if(state.currentIndex == 1){
                ...
                if(count > 0){
                 ...
                 ajax_function(form_data, '' , state.currentIndex);
                }else{
            ...
            if(state.currentIndex == 2){
                ...
                $(document).find('.ser_name').each(function(i) {
                    ...
                    var service_desc = $(this).find('textarea[name="service_name['+i+'][service_desc]"]').val();
            ...
            if(state.currentIndex == 3){
                ...
                if(count > 0){
                    ...
                    // sunday_div
                    // $(".sunday_div:visible").each(function () {
                    //     var that = $(this).find("input[type='time']").val();
                    //     console.log(that);
                    // });
            ...
            //     var count = $(".wizard_cstm_content-select input[type='checkbox']:checked").length;
            //     if(count > 0){
            //         var form_data = new FormData();
            //         form_data.append("_token", CSRF_TOKEN);
            //         form_data.append("step", state.currentIndex);
            ...
            if(state.currentIndex == 4){ // use 4 instead of 5
               ...
               form_data.append("_token", CSRF_TOKEN);
               // form_data.append("step", state.currentIndex); // comment this
            //    form_data.append("step", 5); // add custom step 5
               form_data.append("step", 4); // add custom step 4
               form_data.append("bus_id", bus_id);
               ajax_function(form_data, "gallery"  , state.currentIndex);

            }


            if(state.currentIndex == 5){ // use 5 instead of 6
                ...
                form_data.append("_token", CSRF_TOKEN);
                // form_data.append("step", state.currentIndex); // comment this
                // form_data.append("step", 6); // add custom step 6
                form_data.append("step", 5); // add custom step 5
                form_data.append("bus_id", bus_id);
                ajax_function(form_data, '' , state.currentIndex);
            }
            ...
            if(state.currentIndex == 6){ // use 6 instead of 7
                var form_data = new FormData();
                var terms_title = $(".terms_title").val();
                ...
                form_data.append("_token", CSRF_TOKEN);
                // form_data.append("step", state.currentIndex); // comment this
                // form_data.append("step", 7); // add custom step 7
                form_data.append("step", 6);  // add custom step 6
                form_data.append("bus_id", bus_id);
                ajax_function(form_data, '' , state.currentIndex);
